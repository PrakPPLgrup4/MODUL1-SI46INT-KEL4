...
Route::middleware(['auth'])->group(function () {
    Route::post('/streak/journal', [StreakController::class, 'recordJournalEntry']);
    Route::post('/streak/mood', [StreakController::class, 'recordMoodCheck']);
    Route::get('/streak/data', [StreakController::class, 'getStreakData']);
});
